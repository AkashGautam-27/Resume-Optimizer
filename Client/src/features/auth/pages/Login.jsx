         ...
         <main className="flex min-h-screen items-center justify-center bg-gray-100">
                <div className="w-full max-w-md bg-gray-100 p-8">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        ...
                        <p className="mt-4 text-sm flex justify-center font-medium text-gray-600">Don't have an account? &nbsp;&nbsp;<Link to={"/register"} className="text-blue-500 font-bold transition-all scale-100 hover:scale-110">Register here</Link></p>
                    </form>
                </div>
         </main>
